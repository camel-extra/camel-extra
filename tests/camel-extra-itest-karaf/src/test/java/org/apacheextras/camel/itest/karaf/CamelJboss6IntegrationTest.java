...
public class CamelJboss6IntegrationTest extends AbstractFeatureIntegrationTest {

  public static final String COMPONENT = extractName(CamelJboss6IntegrationTest.class);
