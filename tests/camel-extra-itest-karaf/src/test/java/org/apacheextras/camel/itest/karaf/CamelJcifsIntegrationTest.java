...
public class CamelJcifsIntegrationTest extends AbstractFeatureIntegrationTest {

  public static final String COMPONENT = extractName(CamelJcifsIntegrationTest.class);
