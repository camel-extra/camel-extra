...
public class CamelExistIntegrationTest extends AbstractFeatureIntegrationTest {

  public static final String COMPONENT = extractName(CamelExistIntegrationTest.class);
